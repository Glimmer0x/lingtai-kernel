...
| `adapters/browser_transport.py` | Production static HTTP(S) Adapter for the browser Core-owned `BrowserPort`; pins vetted IPs and preserves Host/SNI, selected lazily by browser setup. |

...
**`venv_resolve.py`**: `resolve_venv` :75 · `venv_python` :102 · `_is_default_runtime_dir` :109 · `_test_venv` :119 · `_create_venv` :157 · `_PythonSelectionPolicy` :195 · `_normalize_selector_architecture` :211 · `_parse_macos_major` :221 · `_python_selection_policy` :235 · `_probe_python_candidate` :312 · `_selection_remedy` :405 · `_find_python` :431 · `_env_marker_status` :556 · `_env_marker_status_detail` :561 · `_remove_mismatched_managed_venv` :634 · `_env_marker_main` :649

...
bash/__init__.py
  ...
  │   ├── _run_sync(command, cwd, timeout) — contained Job Object path on Windows (`_run_sync_contained`, win32_job) with plain subprocess.run fallback; augments result + timeout hint

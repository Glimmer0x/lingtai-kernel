...
- **guards**: `acp-local-stdio` § Behavior and Contract rules 1–8 — see [CONTRACT.md](CONTRACT.md#contract-rules)
...
### Steps
1. From `<repo>`, run `python -m pytest -q -x tests/test_correlated_turns.py tests/test_execution_workspace.py tests/test_session_mcp.py tests/test_acp_stdio.py` with the project Python.

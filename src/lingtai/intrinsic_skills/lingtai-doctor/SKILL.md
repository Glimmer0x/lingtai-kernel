...
|---|---|---|
| `.agent.heartbeat` is fresh | The agent is probably alive; internal email should wake it even if an external addon is broken. | [`email-manual`](../../tools/email/agent_plugin/skills/email-manual/SKILL.md) |

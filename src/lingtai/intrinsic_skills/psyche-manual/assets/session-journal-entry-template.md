...
the `context_molt` action. (The tool result afterward reports the next count,
...
> the complete strict call: `psyche(action="context_molt", input={"summary": ..., "session_journal_path": ..., "keep_tool_calls": null, "keep_last": null})`.

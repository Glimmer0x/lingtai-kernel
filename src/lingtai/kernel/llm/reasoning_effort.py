    ...
    def status(self) -> dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                # ``normalized`` is the descriptor-owned value that a newly
                # captured dispatch should emit. ``None`` deliberately means the
                # provider controls omission; it is never a provider value alias.
                "normalized": effective,
                "effective": effective,
                "emitted": effective,
                "provider_controlled": effective is None,

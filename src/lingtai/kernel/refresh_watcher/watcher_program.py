...
def render_watcher_script(request: RefreshWatcherRequest) -> str:
    ...
    return (
        ...
        "    'Run system(action=\"cpr\", input={\"address\": \"<agent-address>\"}) or manually restart the agent after resolving the blocker.',\n"
        ...
        "        'Inspect logs/refresh_relaunch.log and restart with system(action=\"cpr\", input={\"address\": \"<agent-address>\"}) '\n"

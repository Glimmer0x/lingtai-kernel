...
---
# LingTai kernel 1.0.7 migration

## Applies when

The target kernel release is `1.0.7` / tag `v1.0.7` and that tag lies in the
...
skipped after upgrade because `max_emanations` was removed before `1.0.7`.
...
- Confirm this document identifies the intended kernel release as `1.0.7` /
  `v1.0.7`.

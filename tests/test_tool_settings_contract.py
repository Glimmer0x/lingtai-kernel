...
def test_public_export_and_exact_production_opt_ins():
    ...
    expected_official = {"avatar", "daemon", "email", "mcp", "notification", "plugin", "soul", "system", "task_card"}
    ...
    assert expected_curated | expected_official == {
        "avatar", "cloud_mail", "daemon", "email", "feishu", "imap", "mcp", "notification", "plugin", "soul", "system", "task_card", "wechat", "whatsapp"
    }
